...
public class Layout2EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout2_edit);
    ...
    private void signOut() {
        googleSignInClient.signOut().addOnCompleteListener(this, task -> {
            Toast.makeText(Layout2EditActivity.this, "Signed out successfully", Toast.LENGTH_SHORT).show();
        ...
        executor.execute(() -> {
            try {
                ...
                if (hiWiCalendarId == null) {
                    ...
                    handler.post(() -> Toast.makeText(Layout2EditActivity.this, "HiWi calendar not found.", Toast.LENGTH_SHORT).show());
                    return;
                }
                    ...
                    if (startTime != null && endTime != null) {
                        ...
                        if (nowMillis >= startMillis && nowMillis <= endMillis) {
                            ...
                            if (summary != null && (containsNamePart(summary, userName) || summary.contains("세미나"))) {
                                ...
                                currentEventSummary = filterAndFormatSummary(summary);
                                eventFound = true;
                            }
                        }
                    }
                ...
                handler.post(() -> {
                    ...
                    if (items.size() > 0) {
                        editText_custom.setText(allEventsStringBuilder.toString().trim()); // 모든 일정 표시
                    }
                });

            } catch (IOException e) {
                Log.e("CalendarAPI", "Error fetching events", e);
                handler.post(() -> Toast.makeText(Layout2EditActivity.this, "Error fetching events: " + e.getMessage(), Toast.LENGTH_LONG).show());
            }
        });
    }
    ...
    private String filterAndFormatSummary(String summary) {
        String keyword = "";
    ...
    private void updateLayout() {
        ...
        editText_custom.setCursorVisible(false);
        ...
        Toast.makeText(Layout2EditActivity.this, "Update completed", Toast.LENGTH_SHORT).show();
        ...
        editText_custom.setCursorVisible(true);
    ...
    private void loadAllEditTextContents() {
        ...
        editText_custom.setText(sharedPreferences.getString("Custom", ""));
    }
    ...
    private void saveEditTextContent() {
        ...
        editor.putString("Custom", editText_custom.getText().toString());
        editor.apply();
    }
}
